...
export const productCategories = {
  wheyProtein: {
    ...
    products: [
      ...
      { id: 900, name: "Dymatize Elite", weight: "5LB/2.27KG", flavors: "Rich Chocolate", price: 4899, image: "", route: "/Product" },
      { id: 908, name: "Labrada Whey", weight: "500G", flavors: "Chocolate / Vanilla / Mocha", price: 1299, image: ".", route: "/Product" },
