...
const nextConfig = {
  ...
  env: {
    ...
    NEXT_PUBLIC_RAZORPAY_KEY_ID:
      mergedEnv.NEXT_PUBLIC_RAZORPAY_KEY_ID || mergedEnv.RAZORPAY_KEY_ID || "",
    NEXT_PUBLIC_RAZORPAY_AFFORDABILITY_KEY:
      mergedEnv.NEXT_PUBLIC_RAZORPAY_AFFORDABILITY_KEY ||
      mergedEnv.NEXT_PUBLIC_RAZORPAY_KEY_ID ||
      mergedEnv.RAZORPAY_KEY_ID ||
      "",
